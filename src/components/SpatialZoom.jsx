...
export default function SpatialZoom() {
  ...
  // KEY FIX: offset ['start start', 'end end'] means:
  //   progress=0 when section top hits viewport top (sticky kicks in)
  //   progress=1 when section bottom hits viewport bottom (sticky releases)
  // This keeps scroll progress tied to time INSIDE the pinned window.
